        ...
        <el-table :data="items" v-loading="loading" style="width: 100%">
          ...
          <el-table-column label="操作" width="200" fixed="right">
            <template #default="{ row }">
              ...
              <el-button v-if="isAdmin" link type="success" @click="openTeachers(row)"
                >科任</el-button
              >
      ...
      <el-form label-width="90px">
        ...
        <el-form-item label="年级">
          <el-select v-model="form.grade" style="width: 100%">
            <el-option
              v-for="g in ['一年级', '二年级', '三年级', '四年级', '五年级', '六年级']"
              :key="g"
              :label="g"
              :value="g"
            />
...
async function save() {
  ...
  try {
    const payload = {
      ...
      major: form.major,
      grade: form.grade,
      is_graduated: !!form.is_graduated,
    }
